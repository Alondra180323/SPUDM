                ...
                <form method="post" action="<?= url('/login') ?>" autocomplete="off" class="login-form">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-lg login-input-group">
                            ...
                            <input type="text" class="form-control" id="usuario" name="usuario" value="<?= e($usuarioAnterior ?? '') ?>" placeholder="Número de trabajador, correo o nombre" maxlength="80" required autofocus>
                        </div>
                    </div>
